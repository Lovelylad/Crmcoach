...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setBusinesse(data.data.businesse || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setBusinesse(data.businesse || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.appointments_client = await users.getAppointments_client({
      transaction,
    });

    output.appointments_life_coach = await users.getAppointments_life_coach({
      transaction,
    });

    output.blogs_author = await users.getBlogs_author({
      transaction,
    });

    output.invoices_client = await users.getInvoices_client({
      transaction,
    });
    ...
    output.businesse = await users.getBusinesse({
      transaction,
    });
