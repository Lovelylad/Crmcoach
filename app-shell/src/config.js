...
const config = {
  gcloud: {
    bucket: "fldemo-files",
    hash: "ef6a87bf29f5054e09b92af33171a067"
  },
  bcrypt: {
    saltRounds: 12
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Crmcoach <app@flatlogic.app>',
  ...
  project_uuid: 'fe6c6285-effe-41d3-91fb-b6610ccc8414',
...
config.pexelsQuery = 'path to success metaphor';
