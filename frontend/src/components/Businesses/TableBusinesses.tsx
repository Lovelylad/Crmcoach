...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/businesses/businessesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBusinessesCols';
...
const TableSampleBusinesses = ({
  ...
  useEffect(() => {
    if (businessesNotify.showNotification) {
      notify(
        businessesNotify.typeNotification,
        businessesNotify.textNotification,
      );
    }
  }, [businessesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/businesses/businesses-view/?id=${id}`);
  };
...
export default TableSampleBusinesses;
