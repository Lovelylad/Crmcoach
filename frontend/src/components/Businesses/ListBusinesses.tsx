...
const ListBusinesses = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_BUSINESSES');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/businesses/businesses-edit/?id=${item.id}`}
                  pathView={`/businesses/businesses-view/?id=${item.id}`}
