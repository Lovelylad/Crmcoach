...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/blogs/blogsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBlogsCols';
...
const TableSampleBlogs = ({
  ...
  useEffect(() => {
    if (blogsNotify.showNotification) {
      notify(blogsNotify.typeNotification, blogsNotify.textNotification);
    }
  }, [blogsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/blogs/blogs-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {blogs && Array.isArray(blogs) && !showGrid && (
        <ListBlogs
          blogs={blogs}
          loading={loading}
...
export default TableSampleBlogs;
